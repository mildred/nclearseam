...
function mount_11211685(c_11211690, comp_11211692) {
  var F={procname:"mount.mount",prev:framePtr,filename:"svelte.nim",line:0};
  framePtr = F;
    if (!(!((comp_11211692 == null)))) {
    F.line = 206;
    failed_assert_impl_102680(makeNimstrLit("/var/home/mildred/Projects/nim-svelte/svelte.nim(206, 9) `\x0Anot (comp == nil)` mounted component cannot be nil"));
    }
    
    F.line = 207;
    c_11211690.mount = as_interface_11220756(clone_11220250(comp_11211692));
  framePtr = F.prev;

  
}
function HEX3Aanonymous_11211015(t_11211022) {
    function HEX3Aanonymous_11211267(t_11211274) {
      var F={procname:":anonymous.:anonymous",prev:framePtr,filename:"sample2.nim",line:0};
      framePtr = F;
        F.line = 11;
        mount_11211685(t_11211274, tmpl1_11197879[0]);
      framePtr = F.prev;
  ...
  framePtr = F;
    match_11157347(t_11211022, makeNimstrLit("div.insert"), get_11136014([]), HEX3Aanonymous_11211267);
  framePtr = F.prev;

  
}
var config2_11221595 = [create_11197372(HEX3Aanonymous_11211015)];
var node_11221596 = [document.querySelector("template#sample-2")];
var tmpl2_11221632 = [compile_11197679(config2_11221595[0], node_11221596[0].content)];
if (true) {
attach_11205064(tmpl2_11221632[0], node_11221596[0].parentNode, node_11221596[0], HEX25_10630802([nimCopy(null, {Field0: makeNimstrLit("name"), Field1: HEX25_10630683(makeNimstrLit("Sample-2"))}, NTI11225002), nimCopy(null, {Field0: makeNimstrLit("names"), Field1: new_jarray_10490657()}, NTI11225002)]));
}
